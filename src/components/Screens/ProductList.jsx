...
export default class ProductList extends Basecomponents {
    constructor(props) {
        super(props)
    ...
    render() {
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flex: 1 }}>
                <CompareSortFiltr
                     onFilterPress={()=>this.props.navigation.navigate('Filter')}
                     onComparePress={()=>this.props.navigation.navigate('Compare')}
                    // onSortPress={()=>}
                     />
                    <View>
                        {
